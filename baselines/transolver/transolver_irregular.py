...
from baselines.transolver.physics_attention import Physics_Attention_Irregular_Mesh
...
class TransolverBlockIrregular(nn.Module):
...
class TransolverIrregular(nn.Module):
    def __init__(self, space_dim=1, n_layers=5, n_hidden=256, dropout=0.0, n_head=8,
        ...
        super().__init__()
        self.__name__ = 'Transolver_Irregular'
        self.ref = ref
        ...
        self.blocks = nn.ModuleList([TransolverBlockIrregular(
